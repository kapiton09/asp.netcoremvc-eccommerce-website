...
namespace asp_assignment.Migrations.ApplicationDb
{
    ...
    [Migration("20170501065642_Addresses")]
    partial class Addresses
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("asp_assignment.Models.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("asp_assignment.Models.Identity.UserAddress", b =>
                {
            ...
            modelBuilder.Entity("asp_assignment.Models.Identity.UserAddress", b =>
                {
                    b.HasOne("asp_assignment.Models.Identity.ApplicationUser", "User")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("asp_assignment.Models.Identity.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
